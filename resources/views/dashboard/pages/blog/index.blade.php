...
@push('css')
    ...
    <link rel="stylesheet" href="{{asset('assets/dashboard/assets/vendor/libs/flatpickr/flatpickr.css')}}" />
@endpush
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">DataTables /</span> Advanced
        </h4>
...
@push('js')
    ...
    <script src="{{asset('assets/dashboard/assets/js/tables-datatables-advanced.js')}}"></script>
