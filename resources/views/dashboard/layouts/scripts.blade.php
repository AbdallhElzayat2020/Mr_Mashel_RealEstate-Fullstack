...
<script src="{{asset('assets/dashboard/modules/jqvmap/dist/jquery.vmap.min.js')}}"></script>
<script src="{{asset('assets/dashboard/modules/jqvmap/dist/maps/jquery.vmap.world.js')}}"></script>
